...
private static int count=0;
	...
	protected long accNum=10000000;
	{
		count++;
		accNum+=count;
	}
	...
	public void deposit(double cash) {
		if(balance+cash<500) {
			...
			this.balance+=cash;
			System.out.println("Rs."+cash+" has been succesfully deposited into your account.");
	...
	public boolean withdraw(double withdraw) {
		if(this.balance-withdraw<500) {
			...
			balance-=withdraw;
			System.out.println("Rs."+withdraw+" is withdrawn from your account succesfully");
			return true;
